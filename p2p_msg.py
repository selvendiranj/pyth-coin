...
class ChatClient(Frame):
    ...
    def initUI(self):
        ...
        self.receivedChats.grid(
            row=0, column=0, sticky=W + N + S, padx=(0, 10))
        ...
        bottomLabel = Label(
            parentFrame, text="Created by Siddhartha Sahu (sh.siddhartha@gmail.com) under Prof. A. Prakash [Computer Networks, Dept. of CSE, BIT Mesra]")
